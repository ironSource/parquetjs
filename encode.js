...
module.exports = function (headers, types, table) {
  ...
  var schemas = headers.map(function (name, i) {
    ...
    schema.name = name
    schema.type = pt.Type[types[i]] //binary aka string
...
if(!module.parent)
  process.stdout.write(module.exports(
    ...
    [
      ['one',   10, Date.now()+1000],
      ['two',   20, Date.now()+10000],
      ['three', 30, Date.now()+100000],
      ['four',  40, Date.now()+1000000],
      ['five',  50, Date.now()+10000000]
    ]
  ))
