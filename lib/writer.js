...
class ParquetWriter {
  ...
  static openFile(schema, path, opts) {
    ...
    return new ParquetWriter(
        schema,
        ParquetEnvelopeWriter.openFile(schema, path, opts));
  }
  ...
  close() {
    ...
    this.envelopeWriter.writeFooter();
...
class ParquetEnvelopeWriter {
  ...
  writeFooter() {
    ...
    this.writeSection(encodeFooter(this.schema, this.rowCount, this.rowGroups));
  };
